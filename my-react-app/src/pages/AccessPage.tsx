    ...
    <>
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center text-3xl py-12 text-white">
          ...
          <p className="mb-4">These advantages are reserved for those who book their holiday with Clever Details or entrust us with their property. It's our way of saying thank you by making your stay or investment even more rewarding.</p>
          <p className="mb-4">Explore the full list of partner perks and enjoy more than just a stay.</p>
      ...
      <button className="bg-secondary text-white px-8 py-8 rounded-md mx-auto block mb-12 mt-24 text-5xl">
        Explore Our Homes
      </button>
    </>
  );
